...
<!-- ========================================   PAGE TITLE  ======================================================================== -->
    ...
    <!-- ========================================  BOOTSTRAP ROW     ============================================================== -->
        ...
        for ($i = 0; $i < $numrows; $i++) {
            ...
            echo "<tr>";
            echo "<td>{$row['occur_unit_id']}</td>";
            echo "<td>{$row['occur_unit_name']}</td>";
            echo "<td>{$row['unit_name_status']}</td>";

            echo "<td>{$row['unit_map_loc']}</td>";
            echo "<td>{$row['unit_notes']}</td>";
            ...
            echo "  <td>
                        <div class=\"dropdown\">
                            ...
                            <div class=\"dropdown-menu dropdown-menu-end\">
                                <a class=\"dropdown-item\" href=\"edit_unit.php?id={$row[0]}\">Edit</a>
                                <a class=\"dropdown-item\" href=\"delete_unit.php?id={$row[0]}\">Delete</a>
                            </div>
                        </div>
                    </td>";
