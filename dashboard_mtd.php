                            ...
                            <div class="col-md-12 col-xl-12">
                                <div class="card" style="background-color: #DCDCDC;">
                                    <div class="card-body text-center text-black">
                                        ...
                                        ?> 
                                        <h4><?php echo "MTD:&nbsp" . $formatted_month_name; ?></h4>
                                    </div>
                                </div>
                            </div>
                        </div> <!-- end row -->
...
<!-- SQL QUERY =================================================================================================================== -->
    ...
    $sql = "SELECT *
            ...
            AND occur_date < DATE_FORMAT(DATE_ADD(LAST_DAY(CURDATE()), INTERVAL 1 DAY), '%Y-%m-01')
                ...
                //Set selected month equal to current month in Y-m-d formate
                ...
                document.addEventListener("DOMContentLoaded", function() {
                    var options = {
                        chart: {
                            ...
                            height: 250,
                        toolbar: {
                            show: true // This ensures the toolbar is displayed
                        }
                                        },
                        plotOptions: {
                            pie: {
...
<!-- SCRIPT FOR COLUMN CHART - REPORTS BY DAY -----------------------  -->
