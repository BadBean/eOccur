...
<!-- ========================================   PAGE TITLE  ======================================================================== -->
    ...
    <!-- ========================================  BOOTSTRAP ROW     ============================================================== -->
        ...
        for ($i = 0; $i < $numrows; $i++) {
            ...
            echo "<tr>";
            echo "<td>{$row['occur_area_id']}</td>";
            echo "<td>{$row['occur_area_name']}</td>";
            echo "<td>{$row['occur_area_description']}</td>";
            echo "<td>{$row['occur_area_notes']}</td>";
            echo "<td>{$row['occur_area_status']}</td>";
            ...
            echo "  <td>
                        <div class=\"dropdown\">
                            ...
                            <div class=\"dropdown-menu dropdown-menu-end\">
                                <a class=\"dropdown-item\" href=\"edit_area.php?id={$row[0]}\">Edit</a>
                                <a class=\"dropdown-item\" href=\"delete_area.php?id={$row[0]}\">Delete</a>
                            </div>
                        </div>
                    </td>";
