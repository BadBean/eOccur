...
<!-- PHP / SQL QUERY FOR "NEW REPORTS"    ========================================================================================= -->
 ...
 <div class="d-flex flex-wrap gap-3 align-items-center">
    ...
    <div class="ms-auto">
        <button type="button" class="btn btn-warning btn-sm waves-effect waves-light me-2">Edit</button>
        <button type="button" class="btn btn-warning btn-sm waves-effect waves-light me-2">Print</button>
        <button type="button" class="btn btn-warning btn-sm waves-effect waves-light me-2">Download</button>
        <button type="button" class="btn btn-warning btn-sm waves-effect waves-light">Email</button>
    </div>
</div>
...
<?php
	...
	print"<strong>Reporter: </strong>" . $reporter_first_name . " " . $reporter_last_name . " (" . /*$reporter_job . ",&nbsp" .*/ $reporter_dept . ")" . "&nbsp&nbsp&nbsp&nbsp" . 
	"<strong>Email: </strong>" . $reporter_email ."&nbsp&nbsp&nbsp&nbsp" . "<strong>Phone: &nbsp</strong>" . $reporter_phone . "<strong>&nbsp&nbsp&nbspCell:&nbsp </strong>" . $reporter_cell . "<br>"; 
	...
	print "<strong>Patient:</strong>  " . $patient_first_name . "&nbsp" . $patient_last_name . ", " . $patient_age . " year old " . $patient_gender . "&nbsp&nbsp&nbsp" . "<strong>Attending:</strong>" . "&nbsp" . $md_attending . "<br>";
...
//========================================== MANAGER FOLLOW UP ====================================================
//print"<h5>REVIEW / FOLLOW UP</h5>";
	//print "<br>";


	print"<strong>Manager Review By:&nbsp&nbsp</strong>" . $manager_followup_name . ",&nbsp" . /*$manager_followup_job .*/ "&nbsp&nbsp&nbsp" . "<strong>On:</strong>&nbsp" . $manager_review_date; 
	print "<br>";
	print"<strong>Action Needed:&nbsp&nbsp</strong>" . $manager_action;
	print "<br>";
	print"<strong>Plan:&nbsp&nbsp</strong>" . $manager_followup_plan;
	print "<br>";
	print"<strong>Follow up / Implementation Notes:&nbsp&nbsp</strong>" . "&nbsp&nbsp&nbsp" . $manager_followup_notes  . "<br>";
	//print "<br>";
	
	
	print"<strong>Target Date:&nbsp&nbsp</strong>" . $target_date . "&nbsp&nbsp&nbsp" . "<strong>Completion Date:</strong>" . "&nbsp&nbsp&nbsp" . $complete_date . "&nbsp&nbsp&nbsp" . "<strong>Follow Up Status:&nbsp&nbsp</strong>" . $manager_status . "<br>";
	//print "<br>";
	print "<br>";
	//print "<br>";
...
//========================================== RISK MANAGEMENT / FOLLOW UP ====================================================
	...
	print"<strong>&nbsp&nbspNotes:&nbsp&nbsp</strong>" . "&nbsp&nbsp&nbsp" . $rm_followup_notes;
	print "<br>";
	...
	print"<strong>Additional Notes:&nbsp&nbsp</strong>" . $rm_additional_notes;
	print "<br>";

	print"<strong>Flags:&nbsp&nbsp</strong>" . $occur_flags . "<br>";
