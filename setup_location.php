...
<!-- ========================================   PAGE TITLE  ======================================================================== -->
    ...
    <!-- ========================================  BOOTSTRAP ROW     ============================================================== -->
        ...
        for ($i = 0; $i < $numrows; $i++) {
            ...
            echo "<tr>";
            echo "<td>{$row['setup_location_id']}</td>";
            echo "<td>{$row['setup_location_name']}</td>";
            echo "<td>{$row['setup_location_short_name']}</td>";
            echo "<td>{$row['setup_location_description']}</td>";
            echo "<td>{$row['setup_location_address']}</td>";
            echo "<td>{$row['setup_location_status']}</td>";
            ...
            echo "  <td>
                        <div class=\"dropdown\">
                            ...
                            <div class=\"dropdown-menu dropdown-menu-end\">
                                <a class=\"dropdown-item\" href=\"edit_location.php?id={$row[0]}\">Edit</a>
                                <a class=\"dropdown-item\" href=\"delete_location.php?id={$row[0]}\">Delete</a>
                            </div>
                        </div>
                    </td>";
