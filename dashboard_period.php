...
if (mysqli_num_rows($result_type_table) > 0): ?>
    ...
    $color_array = array_map(function($label) use ($type_styles) {
        return getColorHex($type_styles[$label]['color'] ?? 'text-secondary');
        }, $labels);
