...
<!-- ========================================   PAGE TITLE  ======================================================================== -->
    ...
    <!-- ========================================  BOOTSTRAP ROW     ============================================================== -->
        ...
        for ($i = 0; $i < $numrows; $i++) {
            ...
            echo "<td>$formatted_phone</td>";  // Display formatted phone number
            echo "<td>{$row['user_role']}</td>";
            echo "<td>{$row['super_user']}</td>";
            echo "<td>{$row['user_access_A']}</td>";
            echo "<td>$status_display</td>";  // Apply the span to the status column
            //echo "<td><a href=\"edit_users.php?id={$row[0]}\"><span class=\"fa fa-pencil-alt\"></span></a></td>";
            ...
            echo "  <td>
                        <div class=\"dropdown\">
                            ...
                            <div class=\"dropdown-menu dropdown-menu-end\">
                                <a class=\"dropdown-item\" href=\"edit_users.php?id={$row[0]}\">Edit</a>
                                <a class=\"dropdown-item\" href=\"delete_user.php?id={$row[0]}\">Delete</a>
                            </div>
                        </div>
                    </td>";
