...
<!-- ========================================   PAGE TITLE  ======================================================================== -->
    ...
    <!-- ========================================  BOOTSTRAP ROW     ============================================================== -->
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                       ...
                                       <p>Clinical / Population Groupings</p>
        ...
        for ($i = 0; $i < $numrows; $i++) {
            ...
            echo "<tr>";
            echo "<td>{$row['setup_program_id']}</td>";
            echo "<td>{$row['setup_program_name']}</td>";
            echo "<td>{$row['program_status']}</td>";

            echo "<td>{$row['setup_program_description']}</td>";
            echo "<td>{$row['program_map_age_groups']}</td>";
            echo "<td>{$row['program_notes']}</td>";
            ...
            echo "  <td>
                        <div class=\"dropdown\">
                            ...
                            <div class=\"dropdown-menu dropdown-menu-end\">
                                <a class=\"dropdown-item\" href=\"edit_program.php?id={$row[0]}\">Edit</a>
                                <a class=\"dropdown-item\" href=\"delete_program.php?id={$row[0]}\">Delete</a>
                            </div>
                        </div>
                    </td>";
