...
<!-- ========================================   PAGE TITLE  ======================================================================== -->
    ...
    <!-- ========================================  BOOTSTRAP ROW     ============================================================== -->
        ...
        for ($i = 0; $i < $numrows; $i++) {
            ...
            echo "<tr>";
            echo "<td>{$row['setup_category_id']}</td>";
            echo "<td>{$row['setup_category']}</td>";
            echo "<td>{$row['setup_category_description']}</td>";
            echo "<td>{$row['setup_category_notes']}</td>";
            ...
            echo "  <td>
                        <div class=\"dropdown\">
                            ...
                            <div class=\"dropdown-menu dropdown-menu-end\">
                                <a class=\"dropdown-item\" href=\"edit_category.php?id={$row[0]}\">Edit</a>
                                <a class=\"dropdown-item\" href=\"delete_category.php?id={$row[0]}\">Delete</a>
                            </div>
                        </div>
                    </td>";
