                                ...
                                <div class="card" style="background-color: #DCDCDC;">
                                    <div class="card-body text-center">
                                        <div class="d-flex justify-content-center align-items-center">
                                            <h4 class="mb-sm-0 font-size-16 fw-bold text-black me-2">CATEGORY DETAIL:</h4>
                                            <div class="dropdown">
                                                <a class="dropdown-toggle text-black fw-bold font-size-16" href="#" id="categoryDropdown" 
                                                   data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <?php echo strtoupper($reporter_category); ?>
                                                    <i class="mdi mdi-chevron-down ms-1"></i>
                                                </a>
                                                <div class="dropdown-menu" aria-labelledby="categoryDropdown">
                                                    <?php foreach ($categories as $category): ?>
                                                        <a class="dropdown-item <?php echo ($category == $reporter_category) ? 'active' : ''; ?>" 
...
<!-- =============================================== BOOTSTRAP ROW: CATEGORY TREND CHART  ================================================= -->
    ...
    <!--  TOTAL CATEGORY REPORTS BY MONTH:  COLUMN 1 --------------------- -->
                                        ...
                                        <div class="mt-2 flex-grow-1 overflow-auto">
                                            ...
                                            if (mysqli_num_rows($result_subcategory_table) > 0) {
                                                while ($row_subcategory_table = mysqli_fetch_assoc($result_subcategory_table)) {
                                                    ...
                                                    echo '    </div>';
                                                    echo '    <h6 class="mb-0 font-size-14"><a href="drill_subcategory.php?subcategory=' . urlencode($occur_subcategory_table) . '&category=' . urlencode($reporter_category) . '">' . $count_subcategory_table . '</a></h6>';
                                                    echo '</div>';
                                                }
                                            } else {
...
<!-- ========================================  MIDDLE ROW - 3 WIDGETS / CARDS  =================================================================== -->
    ...
    <!--  TABLE LEVEL OF CARE DETAIL  -  COLUMN 1 --------------------- -->
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center border-bottom pb-2">
                                                            ...
                                                            <div>
                                                                <h5 class="mb-0 font-size-14">
                                                                    <a href="drill_loc.php?loc=<?php echo urlencode($patient_loc_table); ?>&category=<?php echo urlencode($reporter_category); ?>">
    ...
    <!--  TABLE LOCATION DETAIL  -  COLUMN 2 --------------------- -->
                                                ...
                                                <div>
                                                    ...
                                                    ?>
                                                        <div class="d-flex justify-content-between align-items-center border-bottom pb-2">
                                                            ...
                                                            <div>
                                                                <h5 class="mb-0 font-size-14">
                                                                    <a href="drill_location.php?location=<?php echo urlencode($occur_location_table); ?>&category=<?php echo urlencode($reporter_category); ?>">
                                                ...
                                                <div>
                                                    ...
                                                    ?>
                                                        <div class="d-flex justify-content-between align-items-center border-bottom pb-2">
                                                            ...
                                                            <div>
                                                                <h5 class="mb-0 font-size-14">
                                                                    <a href="drill_program.php?program=<?php echo urlencode($patient_program_table); ?>&category=<?php echo urlencode($reporter_category); ?>">
                                            ...
                                            ?>
                                                <div class="d-flex justify-content-between align-items-center border-bottom pb-2 mb-2">
                                                    ...
                                                    <h6 class="mb-0 font-size-14">
                                                        <a href="drill_area.php?area=<?php echo urlencode($occur_area_table); ?>&category=<?php echo urlencode($reporter_category); ?>">
...
<!-- ========================================  BOOTSTRAP ROW:  DATATABLE - REPORTS SUBMITTED   =================================================== -->
    ...
    <!-- SQL QUERY FOR TABLE --------------------------- -->
            ...
            // Set names for title/subtitle on Datatables
                    $datatable_name = "Reports Submitted";
            ?>   
  ...
  $sql = "SELECT *
    ...
    $numrows = mysqli_num_rows($result);
      ...
      // Set datatable titles
                $datatable_name = "Open Reports Requiring Followup";
...
//Query to count # of reports assigned to user and not closed
  $sql = "SELECT *
    ...
    // Set datatable titles
                $datatable_name = "Action Plans in Progress";
                //$datatable_name_sub = $formatted_start_date;
                if ($formatted_end_date) {
                    $datatable_name_sub .= " Through " . $formatted_end_date;
                }
...
//Query to count # of reports assigned to user and not closed
  $sql = "SELECT *
    ...
    // Set datatable titles
                $datatable_name = "Action Plans Completed";
                //$datatable_name_sub = $formatted_start_date;
                if ($formatted_end_date) {
                    $datatable_name_sub .= " Through " . $formatted_end_date;
                }
...
<!-- ========================================  PAGE SPECIFIC SCRIPTS   ========================================================== -->
    ...
    // Move the buttons to buttonsContainer1
    table.buttons().container().appendTo('#buttonsContainer1');
    ...
    // Move the buttons to buttonsContainer1
    table.buttons().container().appendTo('#buttonsContainer2');
    ...
    // Move the buttons to buttonsContainer1
    table.buttons().container().appendTo('#buttonsContainer3');
