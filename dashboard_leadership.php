                            ...
                            <div class="col-md-12 col-xl-12">
                                <div class="card" style="background-color: #DCDCDC;">
                                    <div class="card-body text-center">
                                        <h5 class="mb-sm-0 fw-bold text-black">LEADERSHIP DASHBOARD</h5>
                                        <h4></h4>
                                    </div>
                                </div>
                            </div>
...
<!-- PHP/SQL QUERY AND CARD FOR "NEW REPORTS" COL 1  --------------------- -->
...
<!-- PHP / SQL QUERY FOR "HIGH SEVERITY" COL 2   --------------------- -->

                            <?php 
                                /*
                                //Query to count # of reports with rm_serverity of "Severe" or "Sentinel"
                                    $sql =  "SELECT COUNT(*) AS item_count
                                             FROM occur
                                ...
                                */
                                ...
                                //PDO Version
                                    $sql = "SELECT COUNT(*) AS rm_severity_count
                                            FROM occur
                                            WHERE rm_severity IN (:severity_severe, :severity_sentinel)
                                            AND occur_status <> :occur_status  
                                            ";
                                    try
                                    {
                                        //Prepare the statement
                                        $stmt_rm_severity = $pdo->prepare($sql);
                                        ...
                                        //Execute the statement with the bound parameter
                                       $stmt_rm_severity->execute([
                                        ':severity_severe' => $severity_severe,
                                        ':severity_sentinel' => $severity_sentinel,
                                        ':occur_status' => $occur_status
                                        ]);
                                   ...
                                   $numrows_submitted = $stmt_rm_severity->fetchColumn();
                            ?>
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted mt-3 mb-0"><span class="badge badge-pill badge-soft-danger me-1"><i class="mdi"></i>XX</span> Past Target Date
                                        </p>
                                    </div>
                                </div>
                            </div> <!-- end col-->
...
<!-- PHP / SQL QUERY FOR "MTD TOTALS"  COL 3  --------------------- -->
...
<!-- PHP / SQL QUERY FOR "OPEN REPORTS" - COL 4  --------------------- -->
        ...
        ?>
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Recently Submitted:  Last 30 Days</h4>
