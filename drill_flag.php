         ...
         <?php if (isset($_SESSION['filters'])): ?>
            ...
            <?php else: ?>
                <div class="row mb-4">
                    <div class="col-12">
                        <div class="alert alert-info">
                            <h5>Showing all Flagged Records:</h5>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
...
<!-- SECTION 4: BUILD AND EXECUTE QUERY -->
            ...
            $sql = "SELECT *
                    FROM occur
                    WHERE occur_flag IS NOT NULL
                    AND occur_flag != ''
                    AND occur_date >= '$start_date' 
                    AND occur_date < '$end_date'";

            if (isset($_SESSION['filters'])) {
                // Add filter conditions only if coming from filtered dashboard
            ...
            if (isset($_SESSION['filters'])) {
                $datatable_name = "Flag Detail: All";
