...
include ("includes/occur_config.php");
    ...
    // Define URL parameter to database column mapping and variable names
        $filter_params = [
            ...
            'subcategory' => [
                'db_column' => 'occur_subcategory',
                'variable' => 'selected_subcategory',
                'url_param' => 'subcategory'
            ],
            'loc' => [
...
// Set datatable titles ----------------------------->
            ...
            $datatable_name = "Subcategory Detail for" . " " . $selected_category . ":" . "&nbsp&nbsp&nbsp" . htmlspecialchars($selected_subcategory);
