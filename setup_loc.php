...
<!-- ========================================   PAGE TITLE  ======================================================================== -->
    ...
    <!-- ========================================  BOOTSTRAP ROW     ============================================================== -->
        ...
        for ($i = 0; $i < $numrows; $i++) {
            ...
            echo "<tr>";
            echo "<td>{$row['setup_loc_id']}</td>";
            echo "<td>{$row['setup_loc_name']}</td>";
            echo "<td>{$row['setup_loc_description']}</td>";
            echo "<td>{$row['setup_loc_notes']}</td>";
            echo "<td>{$row['loc_status']}</td>";
            ...
            echo "  <td>
                        <div class=\"dropdown\">
                            ...
                            <div class=\"dropdown-menu dropdown-menu-end\">
                                <a class=\"dropdown-item\" href=\"edit_loc.php?id={$row[0]}\">Edit</a>
                                <a class=\"dropdown-item\" href=\"delete_loc.php?id={$row[0]}\">Delete</a>
                            </div>
                        </div>
                    </td>";
